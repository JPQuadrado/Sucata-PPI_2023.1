...
<body class="my-lg-5">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        ...
        <form class="d-flex mt-3 mt-lg-0" role="search" enctype="application/x-www-form-urlencoded" method="post" action="" id="">
            <input class="form-control me-2" type="search" placeholder="00000-000" aria-label="Search" pattern="\d{5}-\d{3}" name="cep" required>
            <button class="btn btn-success" type="submit" id="">Buscar</button>
        </form>
    </div>
    ...
    <div class="container px-5 py-3" id="featured-3">
        ...
        ?>
            ...
            <table id="pontosBusca" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>CEP</th>
                        <th>Nome</th>
